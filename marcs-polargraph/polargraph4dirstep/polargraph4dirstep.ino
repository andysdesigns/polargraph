...
// Pen raising servo
Servo penHeight;
int const UP_POSITION = 55;  // mxx
int const DOWN_POSITION = 90; // mxx
int const PEN_HEIGHT_SERVO_PIN = 5; //20120128 lanthan  from the Kritzler pinout  // mxx
...
const int motoraStepPin = 6; //20120128 lanthan   pinout from the Kritzler // mxx
const int motoraDirPin = 7;   //20120128 lanthan // mxx
const int motorbStepPin = 8; //20120128 lanthan // mxx
const int motorbDirPin = 9;  //20120128 lanthan // mxx
